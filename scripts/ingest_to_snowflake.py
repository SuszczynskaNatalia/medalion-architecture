...
# ======================================
# Tworzenie bazy i schematu jeśli nie istnieją
# ======================================
cur.execute(f"CREATE DATABASE IF NOT EXISTS {DATABASE}")
cur.execute(f"CREATE SCHEMA IF NOT EXISTS {DATABASE}.{SCHEMA}")
print(f"Baza {DATABASE} i schemat {SCHEMA} gotowe.")
...
if zone_filename in existing_files or f"{TAXI_ZONE_STAGE}/{zone_filename}" in existing_files:
    print(f"Plik {zone_filename} już istnieje na stage {TAXI_ZONE_STAGE}, pomijam.")
else:
...
for year in YEARS:
    for month in MONTHS:
        ...
        # Sprawdzenie czy plik już jest na stage
        if filename in existing_taxi_files or f"{NYC_TAXI_STAGE}/{filename}" in existing_taxi_files:
            print(f"Plik {filename} już istnieje na stage {NYC_TAXI_STAGE}, pomijam.")
            continue
